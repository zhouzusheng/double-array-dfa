...
public class Dfa {
    ...
    public static DfaCompose compose(Collection<Dfa> dfas) {
        DfaCompose dfaCompose = new DfaCompose();
        DeterminizeOperation op = new DeterminizeOperation(union(dfas), dfaCompose);
        op.determinize();
        return dfaCompose;
    }
